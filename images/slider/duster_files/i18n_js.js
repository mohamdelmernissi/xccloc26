...
I18nJs.t = function (str, args, options) {
	...
	if (I18nJs.locale.strings && I18nJs.locale.strings[options.context] && I18nJs.locale.strings[options.context][0][str]) {
		str = I18nJs.locale.strings[options.context][0][str];
	}
